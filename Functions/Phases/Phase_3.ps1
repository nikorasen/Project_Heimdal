...
$Global:rKill_log = "$RAW_LOGPATH\{$Global:DevID}-rKill_Log.txt"
$Global:Kvrt_log = "$RAW_LOGPATH\{$Global:DevID}-KVRT_Log.txt"
$Global:Sophos_log = "$RAW_LOGPATH\{$Global:DevID}-Sophos_log.txt"
$Global:Emisoft_log = "$RAW_LOGPATH\{$Global:DevID}-Emisoft_log.txt"
$Global:Panda_log = "$RAW_LOGPATH\{$Global:DevID}-Panda_log.txt"
$Global:Clam_log = "$RAW_LOGPATH\{$Global:DevID}-Clam_log.txt"
$Global:Comodo_log = "$RAW_LOGPATH\{$Global:DevID}-Comodo_log.txt"
$Global:Mbam_log = "$RAW_LOGPATH\{$Global:DevID}-Mbam_log"
