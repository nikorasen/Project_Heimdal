...
function init_Phase_3
{
    ...
    & M:\Toolbox\Vaccine.exe 2>&1 >> $Global:rKill_log | Out-Null
    ...
    M:\Toolbox\Baptism.exe /path /scan /preinstalled 2>&1 >> $Global:Adw_Cl_Log | Out-Null
    M:\Toolbox\Baptism.exe /clean /preinstalled /noreboot 2>&1 >> $Global:Adw_Cl_Log | Out-Null
