...
function init_Phase_0
{
    ...
    & M:\Toolbox\NetworkTrafficView.exe /stext N:\EncArch\Archive\{$global:DevID}_NetTraffCap.txt /CaptureTime 120 /startashidden
    ...
    & M:\Toolbox\BrowserDownloadsView.exe /stext N:\EncArch\Archive\{$global:DevID}_BrowserDownloads.txt /startashidden
    ...
    & M:\Toolbox\BrowsingHistoryView.exe /stext N:\EncArch\Archive\{$global:DevID}_BrowserHistory.txt /savedirect /historysource 1 /LoadIE 1 /LoadFirefox 1 /LoadChrome 1 /LoadSafari 1 /startashidden  
    ...
    & M:\Toolbox\EdgeCookiesView.exe /LoadFrom 1 /stext N:\EncArch\Archive\{$global:DevID}_EdgeCookies.txt /startashidden  
    Get-Content N:\EncArch\Archive\{$global:DevID}_EdgeCookies.txt 2>&1 >> $Logfile
    & M:\Toolbox\ChromeCookiesView.exe /stext N:\EncArch\Archive\{$global:DevID}_ChromeCookies.txt
    Get-Content N:\EncArch\Archive\{$global:DevID}_ChromeCookies.txt 2>&1 >> $Logfile
    & M:\Toolbox\mzcv.exe /stext N:\EncArch\Archive\{$global:DevID}_FirefoxCookies.txt
    ...
    & M:\Toolbox\OpenedFilesView.exe /stext N:\EncArch\Archive\{$global:DevID}_OpenedFiles.txt /startashidden  
    ...
    & M:\Toolbox\AppNetworkCounter.exe /CaptureTime 20000 /stext N:\EncArch\Archive\{$global:DevID}_NetAppCount.txt /startashidden  
    ...
    & M:\Toolbox\NetworkUsageView.exe /stext N:\EncArch\Archive\{$global:DevID}_NetUsage.txt /startashidden  
    ...
    #Login History
    & M:\Toolbox\WinLogOnView.exe /source 1 /stext N:\EncArch\Archive\{$global:DevID}_Logins.txt /startashidden  
