...
function init_Phase_0
{
    ...
    & C:\EWT\HEIMDAL\Cports.exe /stext N:\EncArch\Archive\{$global:DevID}_Cports_{$Global:Timestamp}.txt /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\{$global:DevID}_Cports_{$Global:Timestamp}.txt 2>&1 >> $Logfile
    ...
    & M:\Toolbox\NetworkTrafficView\NetworkTrafficView.exe /stext N:\EncArch\Archive\{$global:DevID}_NetTraffCap_{$global:Timestamp}.txt /CaptureTime 120 /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\{$global:DevID}_NetTraffCap_{$global:Timestamp}.txt 2>&1 >> $Logfile
    #Browser Downloads
    ...
    & M:\Toolbox\BrowserDownloadsView\BrowserDownloadsView.exe /stext N:\EncArch\Archive\{$global:DevID}_BrowserDownloads_{$global:Timestamp}.txt /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\{$global:DevID}_BrowserDownloads_{$global:Timestamp}.txt 2>&1 >> $Logfile          
    #Browser History
    ...
    & M:\Toolbox\BrowsingHistoryView\BrowsingHistoryView.exe /stext N:\EncArch\Archive\{$global:DevID}_BrowserHistory_{$Global:Timestamp}.txt /savedirect /historysource 1 /LoadIE 1 /LoadFirefox 1 /LoadChrome 1 /LoadSafari 1 /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\{$global:DevID}_BrowserHistory_{$Global:Timestamp}.txt 2>&1 >> $Logfile
    #Browser Cookies
    ...
    & M:\Toolbox\EdgeCookiesView\EdgeCookiesView.exe /LoadFrom 1 /stext N:\EncArch\Archive\{$global:DevID}_EdgeCookies_{$Global:Timestamp}.txt /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\{$global:DevID}_EdgeCookies_{$Global:Timestamp}.txt 2>&1 >> $Logfile
    & M:\Toolbox\ChromeCookiesView\ChromeCookiesView.exe /stext N:\EncArch\Archive\{$global:DevID}_ChromeCookies_{$global:Timestamp}.txt
    ...
    & M:\Toolbox\AppNetworkCounter\AppNetworkCounter.exe /CaptureTime 20000 /stext N:\EncArch\Archive\{$global:DevID}_NetAppCount_{$global:Timestamp}.txt /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\{$global:DevID}_NetAppCount_{$global:Timestamp}.txt 2>&1 >> $Logfile
    # Network Usage
    ...
    & M:\Toolbox\NetworkUsageView\NetworkUsageView.exe /stext N:\EncArch\Archive\{$global:DevID}_NetUsage_{$global:Timestamp}.txt /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\{$global:DevID}_NetUsage_{$global:Timestamp}.txt 2>&1 >> $Logfile
    #Running Tasks
    ...
    & M:\Toolbox\UninstallView\UninstallView.exe /runasadmin /showitemswithoutuninstallstr 1 /showitemswithoutdisplayname 1 /LoadFrom 2 /ShowItemsWithParent 1 /stext N:\EncArch\Archive\unin_app_b4.txt /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\unin_app_b4.txt 2>&1 >> N:\EncArch\Archive\{$global:DevID}_unin_app_b4.txt
    & M:\Toolbox\InstalledAppView\InstalledAppView.exe /stext N:\EncArch\Archive\Inst_App_b4.txt /startashidden | Out-Null
    ...
    & M:\Toolbox\InstallePackagesView\InstalledPackagesView.exe /stext N:\EncArch\Archive\inst_pkg_b4.txt /startashidden | Out-Null
    ...
    & M:\Toolbox\ExecutedProgramsList\ExecutedProgramsList.exe /stext N:\EncArch\Archive\Exe_List.txt /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\Exe_List.txt 2>&1 >> $Logfile
    #Startup Programs
    wmic startup get caption,command 2>&1 >> $Logfile
    #Login History
    & M:\Toolbox\WinLogOnView\WinLogOnView.exe /source 1 /stext N:\EncArch\Archive\{$global:DevID}_Logins_{$global:Timestamp}.txt /startashidden | Out-Null
    Get-Content N:\EncArch\Archive\{$global:DevID}_Logins_{$global:Timestamp}.txt 2>&1 >> $Logfile
    #Services List
